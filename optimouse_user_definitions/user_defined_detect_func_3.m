function Result = user_defined_detect_func_3(imageIn,trim_cycles,GreyThresh_fact,P1,P2,P3,P4,P5)
% example of a user defined detection function accepting 5 custom parameters
%user_detection_functions(3).runstring = 'Result = user_defined_detect_func_3(MedianRemovedImage,trim_cycles,GreyThresh_fact,P1,P2,P3,P4,P5);';
head_method = 7;
...
Result.mouseCOM = mouseCOM+[P1 P2] + P5;
Result.nosePOS  = nosePOS+ [P3 P4] + P5;
