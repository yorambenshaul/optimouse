function Result = user_defined_detect_func_1(imageIn,trim_cycles,GreyThresh_fact,P1,P2)
% example of a user defined detection function with 2 custom parameters
% imposing a shift on detected positions
% user_detection_functions(1).runstring = 'Result = user_defined_detect_func_1(MedianRemovedImage,trim_cycles,GreyThresh_fact,P1,P2);';
head_method = 6;
...
Result.mouseCOM = mouseCOM+[P1 P2];
Result.nosePOS  = nosePOS+ [P1 P2];
